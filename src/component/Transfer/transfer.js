        ...
        <div className={classes.heading}>
          ...
          <div className={classes.ManWoman}>
            ...
            <div className={classes.manContent}>
              <h2>Believe in an open world</h2>
              <p>
                The world is richer when money has no borders. Your ideas fuel
                the Mission Roadmap that's getting us there — tell us what you
                want to see.
              </p>
              <button>Check our Mission Roadmap</button>
            </div>
          </div>
        </div>
      </div>
